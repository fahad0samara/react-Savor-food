...
function Hero() {
    ...
    return (
      <div>
<div className="relative mt-9 mx-auto px-4 pt-16 sm:max-w-xl md:max-w-full md:px-8 lg:py-32 xl:px-20">
      ...
      <svg className="h-full w-full" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="img1" x="0" y="0" width="1" height="1">
            <image x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMaxYMax slice" href={image} /> {/* Use the imported image */}
          </pattern>
        </defs>
