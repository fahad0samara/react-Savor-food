...
{
    return (
        <div className="max-w-screen-xl mx-auto p-5 h-screen">
    <div className="grid grid-cols-1 md:grid-cols-12 border mt-8">
    ...
    Our mission is to provide fresh, delicious food made with high-quality ingredients. With our commitment to excellence,
    we aim to exceed your expectations with every bite. Join us on a culinary journey and experience the flavors of
    perfection!
</p>
            ...
            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-green-600" fill="currentColor" version="1.1" id="Capa_1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                <span className="text-sm">+90 0000 00 0</span>
            </div>
            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-green-600" fill="currentColor" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
...
>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-first-name" type="text" placeholder="fahad"/>
                ...
                <div className="w-full md:w-1/2 px-3">
                    ...
                    <input
                        ...
                        id="grid-last-name" type="text" placeholder="samara"/>
                </div>
            </div>
            <div className="flex flex-wrap -mx-3 mb-6">
    ...
    <button
        onClick={() => history.back()} // Add onClick event handler to go back in history
