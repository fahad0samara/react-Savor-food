    ...
    <div className="container mx-auto ">
      ...
      {cartItems.length === 0 ? (
        ...
        ">
          ...
          <Link to="/menu" className="flex font-semibold text-green-600 text-sm mt-10">
      ...
      <div className="sm:flex shadow-md h-screen">
              ...
              <div key={item.id} className="md:flex items-stretch py-8 md:py-10 lg:py-8 border-t border-gray-50">
                ...
                <div className="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                  <div className="flex items-center justify-between w-full">
                    <p className="text-base font-black leading-none text-green-500">{item.name}</p>
                    <select aria-label="Select quantity" className="py-2 px-1 border bg-green-500 mr-6 focus:outline-none">
                  ...
                  <div className="flex items-center justify-between pt-5">
                    <div className="flex items-center">
                      <p className="text-xs leading-3 underline text-green-500 cursor-pointer">Add to favorites</p>
                    ...
                    <p className="text-base font-black leading-none text-green-500">{item.price}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div id="summary" className="w-full sm:w-1/4 md:w-1/2 px-8 py-10">
          ...
          <div className="border-t mt-8">
            ...
            <button className="bg-green-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">
              Checkout
            </button>
          </div>
        </div>
